...
StageName = Literal["bflow", "vbal", "hdiag", "nicas", "so", "dirac", "plots"]
STAGES: tuple[StageName, ...] = ("bflow", "vbal", "hdiag", "nicas", "so", "dirac", "plots")
...
class PipelinePaths:
    ...
    def from_bflow(
        ...
        """Resolve all downstream workspaces from one BFLOW workspace."""
